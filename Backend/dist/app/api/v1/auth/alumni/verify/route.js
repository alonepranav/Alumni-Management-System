...
function Alumni_Verify(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newToken = jsonwebtoken_1.default.sign({ id: alumni._id, email: alumni.email }, process.env.JWT_SECRET, { expiresIn: "7d" });
            res.status(200).json({
                success: true,
