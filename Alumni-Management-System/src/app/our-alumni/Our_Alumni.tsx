...
export default function Our_Alumni() {
  ...
  return (
    <div className="p-5 py-24">
      <h2 className="text-4xl font-semibold mb-10 text-center">Our Alumni</h2>
...
function Alumni_Box({ data }: { data: Alumni_Type }) {
  return <div className="p-4 border rounded-3xl border-slate-200 hover:shadow-xl hover:shadow-gray-100 min-h-96 w-72">
    ...
    <h3 className="text-xl font-semibold mt-3">{data.name} <span className='text-base font-normal'>( {data.batch} )</span></h3>
